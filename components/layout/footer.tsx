      ...
      <div className="container mx-auto max-w-7xl px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-semibold text-foreground">Irulappan T</span>
            </div>
            <p className="text-sm text-muted-foreground max-w-sm">
              Python Developer & Data Analyst building scalable, data-driven applications with intelligent automation and user-friendly interfaces.
            </p>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center space-y-2 md:space-y-0">
          <p className="text-sm text-muted-foreground">
            © {currentYear} Irulappan T. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
