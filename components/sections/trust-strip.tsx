...
import { Code2, TrendingUp, Users, BarChart, Cloud, BrainCircuit } from "lucide-react";
...
const trustElements = [
    {
        ...
        icon: Code2,
        description:
            "Expert in building robust REST APIs and backend systems using Python, Flask, and modern frameworks for scalable web applications.",
        color: "text-yellow-400",
        bgColor: "bg-yellow-400/10",
        borderColor: "border-yellow-400/20",
    },
    {
        name: "50+ Successful Projects",
        icon: TrendingUp,
        description: "Architected and delivered backend systems and REST APIs for over 50 freelance projects for global clients.",
    ...
    {
        name: "Data Analytics & Visualization Expert",
        icon: BarChart,
        description:
            "Proficient in SQL, Power BI, and data analysis techniques to transform raw data into actionable insights and compelling visualizations.",
        color: "text-accent",
