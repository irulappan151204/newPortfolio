        ...
        >
          ...
          >
            <p className="text-sm text-muted-foreground">
              ...
              <Link href="mailto:irulappan8720@gmail.com" className="text-primary underline hover:text-accent transition-colors">
                Email me directly
              </Link>{" "}
              or connect on{" "}
              <Link href="https://linkedin.com/in/irulappan-t-b69413279" className="text-primary underline hover:text-accent transition-colors">
                LinkedIn
              </Link>.
            </p>
          </motion.div>
